...
FULL_COHORT=/data/jux/BBL/projects/fmriprepdico/script/functional/nfieldmapcohorttask_regressed.csv
...
OUTPUT=/data/jux/BBL/projects/fmriprepdico/data/functional/nbacktaskregressed_nfmapNGSR
