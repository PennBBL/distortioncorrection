...
FULL_COHORT=/data/jux/BBL/projects/fmriprepdico/script/functional/nfmapmiss.csv
...
OUTPUT=/data/jux/BBL/projects/fmriprepdico/data/functional/nbacktaskregressed_nfmapacompcor
